...
class DataInput:
    def __init__(self, data, batch_size):
        ...
        #print('self.batch_num_per_epoch:', self.batch_num_per_epoch)
        #if self.batch_num_per_epoch * self.batch_size < len(data):  # TODO I think this is a bug
    ...
    def __next__(self):
        ...
        watch_history_matrix = np.zeros([len(batch_data), max_watch_history], np.int32)  # TODO original is int64
